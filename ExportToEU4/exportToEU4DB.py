...
RsgTextField(p='GroupBox_2', fieldType='String', ncols=40, labelText=' ', keyword='frames', default='47')
...
RsgFileTextField(p='GroupBox_6', ncols=40, labelText=' ', keyword='fileName', default='E:/Abaqus/2D3DSiatki/8nodes.odb', patterns='Odb(*.odb)')
...
RsgTextField(p='GroupBox_10', fieldType='String', ncols=40, labelText=' ', keyword='fieldOutput', default='S')
RsgGroupBox(name='GroupBox_11', p='VFrame_2', text='Value', layout='LAYOUT_FILL_X|LAYOUT_FILL_Y')
RsgTextField(p='GroupBox_11', fieldType='String', ncols=40, labelText=' ', keyword='value', default='mises')
RsgGroupBox(name='GroupBox_12', p='VFrame_2', text='Min', layout='LAYOUT_FILL_X')
RsgTextField(p='GroupBox_12', fieldType='Float', ncols=40, labelText=' ', keyword='min', default='280')
RsgGroupBox(name='GroupBox_13', p='VFrame_2', text='Max', layout='LAYOUT_FILL_X')
RsgTextField(p='GroupBox_13', fieldType='Float', ncols=40, labelText=' ', keyword='max', default='400')
dialogBox.show()