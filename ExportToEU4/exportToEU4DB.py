...
RsgTextField(p='GroupBox_1', fieldType='String', ncols=40, labelText=' ', keyword='stepName', default='')
RsgGroupBox(name='GroupBox_2', p='VFrame_1', text='Frame', layout='LAYOUT_FILL_X|LAYOUT_FILL_Y')
RsgTextField(p='GroupBox_2', fieldType='String', ncols=40, labelText=' ', keyword='frames', default='')
...
RsgTextField(p='GroupBox_7', fieldType='String', ncols=40, labelText=' ', keyword='folderPath', default='')
RsgGroupBox(name='GroupBox_5', p='VFrame_1', text='Folder Name', layout='LAYOUT_FILL_X|LAYOUT_FILL_Y')
RsgTextField(p='GroupBox_5', fieldType='String', ncols=40, labelText=' ', keyword='folderName', default='')
RsgGroupBox(name='GroupBox_6', p='VFrame_1', text='File Name', layout='LAYOUT_FILL_Y')
RsgFileTextField(p='GroupBox_6', ncols=40, labelText=' ', keyword='fileName', default='', patterns='Odb(*.odb)')
...
RsgTextField(p='GroupBox_10', fieldType='String', ncols=40, labelText=' ', keyword='fieldOutput', default='')
RsgGroupBox(name='GroupBox_11', p='VFrame_2', text='Value', layout='LAYOUT_FILL_X|LAYOUT_FILL_Y')
RsgTextField(p='GroupBox_11', fieldType='String', ncols=40, labelText=' ', keyword='value', default='')
RsgGroupBox(name='GroupBox_12', p='VFrame_2', text='Min', layout='LAYOUT_FILL_X')
RsgTextField(p='GroupBox_12', fieldType='Float', ncols=40, labelText=' ', keyword='min', default='0')
