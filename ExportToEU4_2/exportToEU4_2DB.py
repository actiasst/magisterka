...
dialogBox = RsgDialog(title='Exporter', kernelModule='executeExporter_2', kernelFunction='executePlugin', includeApplyBtn=False, includeSeparator=True, okBtnText='OK', applyBtnText='Apply', execDir=thisDir)
RsgTabBook(name='TabBook_1', p='DialogBox', layout='0')
RsgTabItem(name='TabItem_1', p='TabBook_1', text='I')
RsgVerticalFrame(name='VFrame_1', p='TabItem_1', layout='LAYOUT_FILL_Y', pl=0, pr=0, pt=0, pb=0)
...
RsgTextField(p='GroupBox_2', fieldType='String', ncols=40, labelText=' ', keyword='frames', default='76')
...
RsgFileTextField(p='GroupBox_6', ncols=40, labelText=' ', keyword='fileName', default='E:/Abaqus/2D3DSiatki/6nodes.odb', patterns='Odb(*.odb)')
RsgTabItem(name='TabItem_2', p='TabBook_1', text='II')
RsgVerticalFrame(name='VFrame_2', p='TabItem_2', layout='LAYOUT_FILL_X', pl=0, pr=0, pt=0, pb=0)
RsgGroupBox(name='GroupBox_10', p='VFrame_2', text='FieldOutput', layout='LAYOUT_FILL_X|LAYOUT_FILL_Y')
RsgTextField(p='GroupBox_10', fieldType='String', ncols=40, labelText=' ', keyword='fieldOutput', default='U')
RsgGroupBox(name='GroupBox_11', p='VFrame_2', text='Value', layout='LAYOUT_FILL_X|LAYOUT_FILL_Y')
RsgTextField(p='GroupBox_11', fieldType='String', ncols=40, labelText=' ', keyword='value', default='U1')
RsgGroupBox(name='GroupBox_12', p='VFrame_2', text='Min', layout='LAYOUT_FILL_X')
RsgTextField(p='GroupBox_12', fieldType='Float', ncols=40, labelText=' ', keyword='min', default='-4')
RsgGroupBox(name='GroupBox_13', p='VFrame_2', text='Max', layout='LAYOUT_FILL_X')
RsgTextField(p='GroupBox_13', fieldType='Float', ncols=40, labelText=' ', keyword='max', default='0')
dialogBox.show()